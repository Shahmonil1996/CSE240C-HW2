...
#echo "All Traces for LIME BINARY  COMPLETED"
while read line;  do
     ./bin/lru-config2-ship -warmup_instructions 10000000 -simulation_instructions 100000000 -traces /datasets/cs240c-wi22-a00-public/data/Assignment2-gz/$line | tee results/ship-baseline/result_$line.txt &
     done < "$trace_input"
wait
echo "All Traces for LIME BINARY  COMPLETED"
while read line;  do
     ./bin/lru-config2-hawkeye -warmup_instructions 50000000 -simulation_instructions 100000000 -traces /datasets/cs240c-wi22-a00-public/data/Assignment2-gz/$line | tee results/hawkeye-baseline/result_$line.txt &
     done < "$trace_input"
wait
echo "All Traces for LIME BINARY  COMPLETED"
while read line;  do
     ./bin/lru-config2-baseline -warmup_instructions 50000000 -simulation_instructions 100000000 -traces /datasets/cs240c-wi22-a00-public/data/Assignment2-gz/$line | tee results/baseline/result_$line.txt &
     done < "$trace_input"
wait
echo "All Traces for LIME BINARY  COMPLETED"
